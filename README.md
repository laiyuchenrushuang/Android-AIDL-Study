# Android-AIDL-Study
1. [笔记](https://blog.csdn.net/MoLiao2046/article/details/105470830)
2. 对`IBookManager.aidl`文件生成的Java类分析.
```java
public interface IBookManager extends android.os.IInterface {
  ...
  public static abstract class Stub extends android.os.Binder implements IBookManager {
    ...
    private static class Proxy implements IBookManager {
      ...
      // 向服务端发送客户端传递过来的参数
      // 挂起当前线程
      // 接收到服务端线程通知,继续执行客户端线程,并返回到客户端代码区.
      ...
      // 返回当前Binder代理对象对应的Binder引用对象,它是在Binder驱动中存在.
      @Override
      public android.os.IBinder asBinder() {
        return mRemote;
      }
